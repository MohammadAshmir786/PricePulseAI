...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // success handled by Navigate via user state
    } catch (err) {
  ...
  return (
    <>
      <PageMeta
        title="Login - PricePulseAI"
        description="Login to your PricePulseAI account to access personalized price tracking, alerts, and more."
      />
